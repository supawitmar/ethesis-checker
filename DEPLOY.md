...
> **ไม่ตั้ง `ANTHROPIC_API_KEY` ระบบตรวจได้ครบทุกกฎ** รวมถึงการเทียบชื่อ-ลำดับ
> กรรมการของเล่มภาษาอังกฤษ เพราะระบบถอดชื่อไทยเป็นอังกฤษเองในเครื่องด้วย
> `pythainlp` (ดู `translit.py`) ไม่ต้องใช้ API และไม่มีค่าใช้จ่าย
> คีย์มีผลกับ "ข้อความสรุปที่เรียบเรียงด้วย AI" อย่างเดียว
