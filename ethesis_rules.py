...
RULE_CATALOG = {
    ...
    "FRONT.COMMITTEE_DEGREE": {
        "title": "บรรทัดคุณวุฒิใต้ชื่อกรรมการบนหน้าลงนาม (ข้อสังเกต)",
        "basis": "กติกาปฏิบัติงานของเจ้าหน้าที่",
        "failure_zone": "YELLOW",
        "references": (
            "คู่มือ หน้า 11-12 และ template ตารางลายเซ็น (ใต้ชื่อมีบรรทัดคุณวุฒิ)",
            "กติกาปฏิบัติงาน (ส.ค. 2569): เรื่องคุณวุฒิบนหน้าลงนามให้แจ้งเป็น"
