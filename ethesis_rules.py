...
NOT_CHECKED = (
    ...
    "(ระบบตรวจว่ามีบรรทัดคุณวุฒิครบทุกคน + ตรวจชื่อ-สกุลกรรมการ "
    "เมื่อดึงข้อมูลจาก eThesis ได้ แต่ไม่ตรวจว่าคุณวุฒิถูกต้องหรือไม่)",
    "ตำแหน่งการวางชื่อกรรมการในตาราง (แต่ละเล่มจัดหน้าไม่เหมือนกัน ระบบดูเฉพาะว่าชื่อครบและถูกคน)",
