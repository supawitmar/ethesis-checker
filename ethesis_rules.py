...
NOT_CHECKED = (
    ...
    "ตัวสะกดระดับวรรณยุกต์และสระของชื่อกรรมการ และการเทียบชื่อบนหน้าที่พิมพ์"
    "เป็นภาษาอังกฤษ (ต้นทางเก็บชื่อเป็นภาษาไทย ระบบจับคู่ตัวอักษรไม่ได้ "
    "จึงพิมพ์รายชื่อไว้ในรายการสีม่วงให้เจ้าหน้าที่ทานเอง)",
