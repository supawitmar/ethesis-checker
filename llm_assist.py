...
- แยกให้ชัดว่าอะไร "ต้องแก้" อะไร "รอเจ้าหน้าที่ยืนยัน" (ยังไม่ต้องแก้) และอะไรเป็น
  "ข้อสังเกต" (ไม่บังคับแก้)
- ขึ้นต้นด้วยสรุปภาพรวมสั้น ๆ 1-2 ประโยคว่าผลเป็นอย่างไรและมีกี่จุดที่ต้องแก้
