...
# **ต้องแก้คู่กับ formatDegreeAbbreviation ใน templates/index.html** (ทางวางข้อความ eThesis)
# มีเทสต์เทียบสองตารางไว้ — เคยหลุดกันจริง หน้าเว็บขาด D.N.S. / D.P.A. / Dr. P.H. / M.P.A.
DEGREE_ABBR = {
