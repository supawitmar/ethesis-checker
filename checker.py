                    ...
                    for abs_page_idx in range(ai, min(ai + span_of(ai), n)):
                        ...
                        if bold_lines:
                            ...
                            rep.add(ABSTRACT_BOLD_ZONE, "front_matter",
                                    ...
                                    # หัวข้อบทคัดย่อเป็นตัวหนาตาม template อยู่แล้ว (ยกเว้นไว้ใน
                                    # _is_abstract_heading) ประโยคจึงต้องบอกข้อยกเว้นนี้ด้วย
                                    "หน้าบทคัดย่อต้องไม่มีข้อความตัวหนา ยกเว้นหัวข้อบทคัดย่อ",
