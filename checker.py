...
def _check_committees(rep, committees, sig_pages, pages, pdf_path, page_ref,
    ...
    for idx in sig_pages[:2]:
        ...
        if not kind:
            rep.add(UNCERTAIN_ZONE, "front_matter", loc,
                    "ระบบแยกไม่ออกว่าหน้านี้เป็นหน้าคณะกรรมการที่ปรึกษาหรือคณะกรรมการสอบ "
                    "จึงนับจำนวนอาจารย์เทียบฟอร์มให้ไม่ได้",
                    "หน้าลงนามหน้าแรกต้องเป็นคณะกรรมการที่ปรึกษา (บฑ.1) "
                    "หน้าที่สองต้องเป็นคณะกรรมการสอบ (บฑ.2)",
                    "ตรวจว่าหัวข้อและเลขหน้าบนหน้านี้ถูกต้อง แล้วนับจำนวนอาจารย์ด้วยตา",
                    "UNCERTAIN.REVIEW")
        if not expected:
            continue
        handled_any = True
